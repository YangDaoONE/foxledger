...
- V3.2 M0–M2 已按 `docs/V3.2_EXECUTABLE_DESIGN.md` 完成实现、自动化验收、生产部署和服务器产物核对；收口前仍需真实手机安装态 PWA 更新验收。
- 未获得用户真机验收确认前，不得把 V3.2 写为正式收口或主动开始后续版本；确认收口并明确启动新版本后，先以当时代码为准编写新版本可执行设计。
