  ...
  return [
    {
      ...
      content: [
        ...
        "raw_text must keep the original date expression and amount that belong to that transaction.",
        ...
        `Resolve compact date/amount notation from context: "今天，7.6吃饭" means amount 7.6 on ${todayIsoDate}; "7.6吃饭花了76" means date ${todayIsoDate.slice(0, 4)}-07-06 and amount 76. A decimal followed by a currency unit is always an amount.`,
        "If a bare compact decimal such as 7.6 has no date context and no second amount, keep the candidate but set needs_clarification to true instead of guessing whether it is a date or amount.",
